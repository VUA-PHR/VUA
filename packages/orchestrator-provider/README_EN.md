...
See the [VUA Application Contract v0.1](../../docs/protocols/application-contract-v0.1_EN.md) and
[Supervised Provider Process Protocol v0.1](../../docs/protocols/provider-process-v0.1_EN.md).
