...
> 更新：2026-09-20  
> 权威：`docs/product-boundary_ZH.md` 1.4.0（用户裁决 U3，2026-09-08；设置面例外 U14，2026-09-19）

## 权威与硬边界

本矩阵是产品边界 1.4.0 的展开，不引入新语义。VUA 对 ALCOM/VCC 管理的原项目**只读**；
...
`vcc.liteDb` 等其余存储面维持禁止不变，项目文件面只读不变（权威措辞见产品边界 1.4.0
「明确边界」节）。
