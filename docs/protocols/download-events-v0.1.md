...
> Ownership boundaries: `docs/architecture/desktop.md` (Electron owns Session/
...
The layout is governed by `docs/decisions/warehouse-layout.md` (accepted,
...
The F line accepted all four items (`docs/plans/f-reply-to-b4-download-port-alignment.md`);
