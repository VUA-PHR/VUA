...
> [Unity Editor compatibility policy](../compatibility/unity-editor_EN.md) and the design
> standard
...
2. **Remedial manual selection**: a manual picker appears only when detection fails or no
   ...
   [compatibility policy](../compatibility/unity-editor_EN.md) and are **never silently used**;
...
[Unity Editor compatibility policy](../compatibility/unity-editor_EN.md); settings
