...
- 1.2.1（2026-09-23）：EN 镜像结构对齐补齐——「作业与安全」在 EN 独立成节，找回折叠中丢失的
  「Orchestrator 原子写请求，Unity 原子写结果」与「指纹不匹配须重新 Inspect」两子点，
  「Unity Bridge 边界」节补回「最终登录与上传保留在官方 SDK Panel」；权威 ZH 内容零变更。
