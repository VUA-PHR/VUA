...
[Supervised independent-process Orchestrator Provider](../decisions/orchestrator-supervised-provider.md)):
...
- inter-process communication uses the versioned frame protocol
  ([Supervised Provider Process Protocol v0.1](../protocols/provider-process-v0.1.md)) with
...
- authoritative task state lives in SQLite ([Task Store Format v0.1](../protocols/task-store-v0.1.md));
