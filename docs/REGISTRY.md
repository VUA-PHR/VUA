...
| docs/protocols/packages-ops-v0.5_ZH.md | 0.5 | 已冻结（包管理 P3 写面 A5 项目创建词表行，2026-09-19：单方法一次冻结〔无 preview 对偶第二员——端口事实如实立面；创建即在册副作用如实载明〕，双语协议本＋REGISTRY 登记随本冻结批；明确词面之外节载明 templates.* 枚举不立／projectId 非身份参数〔013 裁决不变〕／文件系统读面不立；诚实边界节如实「已冻结未接线」——wire 路由候下一核心接线切片，落地前桌面无创建入口、mock 恒答诚实缺席） | 核心 | 2026-09-19 |
