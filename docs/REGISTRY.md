...
| schemas/project-inspection/v0.1（snapshot + read command/result schema） | 0.1 | 已取代（→ v0.2） | 环境 | 2026-09-09 |
| schemas/project-inspection/v0.2（snapshot + read command/result schema；新增 vuaIdentity 判定） | 0.2 | 已冻结 | 环境 | 2026-09-09 |
| schemas/project-ops/v0.1（import-copy command/result schema） | 0.1 | 已冻结 | 环境 | 2026-09-09 |
...
| docs/design/design-standard_ZH.md | 0.6.3 | 已接受 | 桌面 | 2026-09-08 |
