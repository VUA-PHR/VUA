...
| docs/protocols/packages-ops-v0.3_ZH.md | 0.3 | 已冻结（包管理 P3 写面 A3 本地包注册词表行，2026-09-19：单方法一次冻结〔无 preview 对偶——端口事实如实立面〕，双语协议本＋REGISTRY 登记随本冻结批；诚实边界节载明词面尚未接线——wire 路由/served 行/信封组装候下一核心接线切片，接线前方法在 wire 面不存在） | 核心 | 2026-09-19 |
