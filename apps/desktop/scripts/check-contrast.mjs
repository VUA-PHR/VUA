 ...
 *
 * 辖区必须使用真实模块标识(§3.2.2):紫辖区 = env / guide / tools /
...
const contexts = {
  "深色·紫辖区(env/guide/tools/settings)": makeContext(buckets.base),
  "深色·橙辖区(production)": makeContext(buckets.base, buckets.darkProduction),
  "浅色·紫辖区(env/guide/tools/settings)": makeContext(buckets.base, buckets.lightBase),
