...
rolled_back: "已回滚",
  ...
  inspection: {
    ...
    reportTitle: '报告',
    emptyTitle: '检查证据面尚未接入',
    emptyDesc: '检查随装配流程产生;证据读面落地后,报告会出现在这里。',
    evidenceTitle: '证据',
    evidenceEmptyNote: '检查证据链(快照/Bridge 作业/本地 VPM/验证)尚未接入——不以演示替代。',
    nextTitle: '下一步',
    localVsOfficialNote: '本页将区分本地估算与官方结论;官方 SDK 结论为保留值,交接切片落地前不呈现。',
  },
  dev: {
