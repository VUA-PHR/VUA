...
rolled_back: "Rolled back",
  ...
  settings: {
    ...
    experimental: {
      ...
      deleteBadge: "Danger",
      deleteDesc: "Deletes the original .unitypackage files once VPM generation completes. This is irreversible; enable only after confirming the generated quality. Requires “Generate VPM package replacement” first.",
