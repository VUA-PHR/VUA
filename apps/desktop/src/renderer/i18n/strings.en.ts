...
rolled_back: "Rolled back",
  ...
  settings: {
    ...
    experimental: {
      ...
      generateNotWired: "Auto-generation at import time is not wired yet: in the current version, generation is still started manually from the warehouse entry (the entry then appears in the task center).",
