...
rolled_back: "Rolled back",
  ...
  settings: {
    ...
    experimental: {
      ...
      warehouseModeDesc: "When on, the warehouse entry drawer shows the artifact-mode editor and the “Generate VPM / Delete originals” entry actions (using the frozen bdl-commands v0.1 entry-level commands). The global default is decided by server configuration; no global-default toggle is provided here.",
      on: "On",
      off: "Off",
    },
    goals: {
