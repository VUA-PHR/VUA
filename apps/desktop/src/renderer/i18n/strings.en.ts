...
demoTaskTitle: "Demo task",
  ...
  packages: {
    ...
    p2: {
      ...
      browseNotCachedDescription: "This repository is subscribed but has no local cache inventory yet; there is nothing to browse until a cache exists.",
      browseEmptyTitle: "No packages in this repository's cache",
      browseEmptyDescription: "The local cache lists no packages — this is the current cache fact, not an availability claim.",
      ...
      browseLatestNone: "No qualifying version",
  ...
  compose: {
    ...
    nameHintPlaceholder: 'Mount name (required if cleared)',
    nameHintAria: 'Mount name hint for {title}',
    advancedMountToggle: 'Mount names (advanced)',
    autoNameNote: 'Mount names are auto-filled from entry titles - override only if needed.',
