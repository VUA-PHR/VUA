...
最近更新：2026-09-10 01:30 第四批（**全员空转触发登记＋备稿转正为可领工单
...
- **今夜可领工单（BG-1～BG-6；2026-09-10 01:30 空转触发后由集成备稿转正）**：
  ...
  | BG-4 | **M7 可前置**：检查证据面（功能/性能/依赖/光照/上传准备度）契约预备 | 产线主导（协作核心、环境——性能/依赖事实源与其域相关） | Schema 草案＋正负例向量（proposal 承载） | 向量过 schema 校验；**冻结硬前置齐前不得标冻结**（治理 §2.5）；入 proposal 待仲裁，不直接动 REGISTRY |
