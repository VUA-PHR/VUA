...
| M7 | **部分提前开工**（用户裁决 2026-09-15，操作者转达） | 授权范围＝M7 分解表前四行（检查证据〔产线/核心〕、报告/快照/只读服务〔核心/桌面〕、Inspection/Release 页面与官方 SDK 交接〔桌面/产线〕、桌面 Overlay 收尾〔桌面/核心〕）；**门验收与发行不在提前授权范围**（候 M5 关门门序）。既有契约前置已在库（016 链：inspection-evidence v0.1 冻结 75f9d15＋unity-bridge v3 冻结 4bc0257〔三只读检查操作锚点实现 7d63abe〕＋核心检查切片实现批 7a262b8＋inspection-queries v0.1 冻结 f84b397）。各角色按锚点领取，开工前先合并 main 最新；分解表节前授权注记见 outline 2.0.12 双语 |
