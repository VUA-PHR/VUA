...
| U6 | **[需用户→✅ 已销账] W15 确认后问题清单 B8/B9 指代澄清** | 集成 | **✅ 用户已澄清（2026-09-09 13 项裁决回传）**：B8/B9 指代＝关门确认文档 line80——B8「确认并开始导入（DEV fixture）完成呈现（新项目路径/已复制数据/已复制内容/来源关系/重新检查）」；B9「真实 provider 场景同一提交呈现『项目操作服务尚未接入或暂不可用』（接线前诚实反馈，合格态）」——两段测试范围随之明确（桌面今夜实现批含） |
