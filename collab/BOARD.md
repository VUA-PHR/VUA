...
最近更新：2026-09-08 05:3x（**proposal 010 已接受·收口**〔数据六点＋桌面三项表态
齐：bdl-commands 升 v0.3 承载 warehouse.import、读时求值确认、标注移除双条件；
集成收口＝**v0.3 冻结 M5 首批内先行**＋importCorrelationId 归属随冻结定＋执行序
①v0.3 冻结→②核心 wire/挂点→③桌面导入 UI＋008 接线呈现〕；**009 核心四问表态
已到**——三契约互审后再冻结（产线 v2↔核心 W20↔W22 Record）；W25 真机窗口预约
维持，等操作者/用户开窗）
