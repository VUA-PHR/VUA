...
> [!IMPORTANT]
> **現在の製品バージョンは v0.6.0（pre-alpha）です。リリースノートは [docs/release/](docs/release/) を
> 参照してください。** このリポジトリは早期評価と開発向けで、一般ユーザーの日常利用に適した安定版ではありません。
...
- **デスクトップ／VR Overlay:** 安定したアプリケーションサービスから状態と案内を表示します。
  VR Overlay は `1.0.0` 以降の方向アンカーです。
